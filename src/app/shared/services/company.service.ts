...
export class CompanyService {
  ...
  updateBuilding(data: FormData, id): Observable<Company> {
    return this.http.post<Company>(`${this.endpoint}/${id}/building`, data);
  }
  ...
  validateCompany(id, data): Observable<null> {
    return this.http.patch<null>(`${this.endpoint}/${id}/validate`, data);
  }
  ...
  getListCompaniesMap(): Observable<any[]> {
    return this.http.get<any[]>(`${this.endpoint}/all-validate-map`);
  }
}
