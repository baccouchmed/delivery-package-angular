...
export class GroupService {
  ...
  //update group
  updateGroup(group: Group, groupFeature): Observable<Group> {
  ...
  getAllDelivery(): Observable<User[]> {
    return this.http.get<User[]>(`${this.endpoint}/deliveries`);
  }
  getAllPickUp(): Observable<User[]> {
    return this.http.get<User[]>(`${this.endpoint}/pickups`);
  }
  getAllProvider(): Observable<User[]> {
    return this.http.get<User[]>(`${this.endpoint}/providers`);
  }
}
